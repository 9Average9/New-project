...
function toggleImageDisplay() {
  ...
  if (characterImage.src) {
    largerImageContainer.style.display = (largerImageContainer.style.display === 'none') ? 'block' : 'none';
  }
}

// You can call this function when the image is generated dynamically
